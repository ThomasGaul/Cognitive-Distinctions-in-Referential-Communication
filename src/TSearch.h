...
class TSearch {
    ...
    void SetRandomSeed(long seed) {rs.SetRandomSeed(seed);};
		...
		void SetPopulationVectorInterval(int NewInt) {PopVectInt = NewInt;};
		int PopulationVectorInterval(void) {return PopVectInt;};
		RandomState &IndividualRandomState(int i) {return RandomStates(i);};
		// Function Pointer Accessors
		void SetEvaluationFunction(double (*EvalFn)(TVector<double> &v, RandomState &rs))
			{EvaluationFunction = EvalFn;};
		void SetBestActionFunction(void (*BestFn)(int Generation,TVector<double> &v, double BestPerf))
		...
		void SetWritePopulationVectorFunction(void (*WriteFn)(TVector<double> &Perf, int Gen))
			{WritePopulationVectorFunction = WriteFn;};
    ...
    TVector<RandomState> RandomStates;
		...
		void (*BestActionFunction)(int Generation,TVector<double> &v, double BestPerf);
		...
		void (*WritePopulationVectorFunction)(TVector<double> &fitness, int gen);
};
